...
import { ExtentedRequest, LoginInput, Member, MemberInput, MemberUpdateInput } from "../libs/types/member";
...
memberController.getMemberDetail = async (req: ExtentedRequest, res: Response) => {
  try {
